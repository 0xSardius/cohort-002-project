...
export const rerankEmails = async (
  ...
  const rerankedResults = await generateObject({
    ...
    system: ` You are a search result reranker. Your job is to analyze a list of email chunks and return only the IDs of the most relevant chinks for answering the user's question.
